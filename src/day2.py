...
chat=["OutbackAddy:","OutbackAddy ", f"<img>ImageDay{day}_1.png",f"<img>ImageDay{day}_2.png", " ","Isn't the view","from there ","so pretty???","","I thought you'd"," like it :D"," ","Have you been","doing okay?"]
anachat="yea im ok"
